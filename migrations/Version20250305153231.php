 ...
 */
final class Version20250305153231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tache (id INT AUTO_INCREMENT NOT NULL, chantier_id INT NOT NULL, description LONGTEXT DEFAULT NULL, statut VARCHAR(255) NOT NULL, duree DOUBLE PRECISION NOT NULL, date_de_fin DATE NOT NULL, INDEX IDX_93872075D0C0049D (chantier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
